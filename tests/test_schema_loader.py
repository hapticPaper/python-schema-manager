...
class TestSchemaLoader:
    ...
    def test_load_from_dict_minimal_schema(self):
        ...
        schema_dict = {"name": "minimal_table", "columns": [{"name": "col1", "type": "STRING"}]}
    ...
    def test_load_from_dict_empty_columns(self):
        ...
        schema_dict = {"name": "empty_table", "columns": []}
    ...
    def test_load_from_dict_invalid_mode(self):
        ...
        schema_dict = {
            "name": "test_table",
            "columns": [{"name": "col1", "type": "STRING", "mode": "INVALID_MODE"}],
        }
    ...
    def test_load_from_dict_mode_case_insensitive(self):
        ...
        schema_dict = {
            "name": "test_table",
            "columns": [{"name": "col1", "type": "STRING", "mode": "required"}],
        }
    ...
    def test_load_from_json_string(self):
        ...
        json_string = json.dumps(
            {"name": "json_table", "columns": [{"name": "id", "type": "INTEGER"}]}
        )
    ...
    def test_repeated_mode(self):
        ...
        schema_dict = {
            "name": "test_table",
            "columns": [{"name": "tags", "type": "STRING", "mode": "REPEATED"}],
        }
